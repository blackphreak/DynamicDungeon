...
public class DungeonSession {
	...
	private CuboidSelection region = null;
	...
	public DungeonSession(Player p_caller, CuboidSelection p_region, EditSession p_session, Location playerSpawnLocation, Location min, Location max) {
	...
	public DungeonSession(Player p_caller, CuboidSelection p_region, EditSession p_session, Location min, Location max) {
		this.sessionOwner = p_caller;
		this.session = p_session;
		this.region = p_region;
		this.sessionID = gb.dungeons.size();
