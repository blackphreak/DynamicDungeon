...
//			db.log("max: " + max.getX() + " | " + max.getY() + " | " + max.getZ());
            ...
            IAsyncCommand asyncCommand = AsyncWorldEditBukkit.getInstance().getOperations().getChunkOperations().createPaste(iPlayer, new com.sk89q.worldedit.util.Location(region.getWorld(), region.getMinimumPoint()), region.getWorld(), null, clipboardHolder, false, true, false);
