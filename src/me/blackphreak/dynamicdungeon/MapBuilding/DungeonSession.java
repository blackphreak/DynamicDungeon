...
public class DungeonSession {
    ...
    */
	...
	public DungeonTrigger getTriggerByName(String name) {
    ...
    */
	...
	/**
	 * void fireTheTrigger:
	 * this method will be called by TriggerAction.
	 * if the target trigger is DungeonTrigger (&& not activated),
	 * this will activate it.
	 * if the target trigger is PassiveTrigger,
	 * this will directly tell it to action (no).
	 *
	 * @param triggerName
	 */
	...
	public void addTrigger(DungeonTrigger dt) {
		if (dt instanceof PassiveTrigger)
			passiveTriggers.add(dt);
		else
			triggers.add(dt);
	}
