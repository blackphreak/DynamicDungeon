...
//            WorldData weWorldData = new BukkitWorld(gb.nextDungeonLocation.getWorld()).getWorldData();
//
...
//             */
//
//            Location loc = gb.nextDungeonLocation.add(50 /*clipboard.getRegion().getWidth() + 50*/, 0, 0 /*clipboard.getRegion().getLength() + 20*/);
//
//
...
////                    }
////                }
////                db.log("unloaded " + unloaded + " chunks on dungeonWorld");
//
...
//                {
//                    db.tlog("Load chunk on [x:" + chunk.getX() + ", z:" + chunk.getZ() + "]");
//
...
//                                        sign.getLocation(),
//                                        (new SpawnerManager(MythicMobs.inst())).getSpawnerByName(sign.getLine(1)));
//
...
//            {
//                db.log("--> " + iJobEntry.getStatus().getSeqNumber() + " | " + iJobEntry.getStatusString() + " | " + iJobEntry.getName() + " | " + iJobEntry.isTaskDone());
...
//                {
//                    db.log("jobAdded -- " + job.isTaskDone());
...
//                {
//                    db.log("jobRemoved -- " + job.isTaskDone());
//                    if (job.getPlayer().getUUID() == iPlayer.getUUID())
//                    {
//                        //if (job.getPlayer().isConsole()) {
